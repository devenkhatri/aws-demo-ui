const LoginForm = ({
    ...
    return (
        <form className="flex flex-col bg-white rounded shadow-lg p-12 mt-12" onSubmit={onSubmit}>
            ...
            <button className="flex items-center justify-center h-12 px-6 w-64 bg-orange-500 mt-8 rounded font-semibold text-sm text-orange-100 hover:bg-orange-700">Login</button>
